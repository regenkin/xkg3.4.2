	...
	public class VProductListAll : VMemberTemplatedWebControl
	{
		...
		protected override void OnInit(System.EventArgs e)
		{
			...
			if (a == "next")
			{
				...
				int num;
				DataTable products = ProductBrowser.GetProducts(MemberProcessor.GetCurrentMember(), null, new int?(this.categoryId), this.keyWord, int.Parse(text2), int.Parse(text), out num, "DisplaySequence", "desc", false);
