    ...
    var bigAutocomplete = new function () {
        ...
        this.init = function () {
            ...
            $("#bigAutocompleteContent").delegate("tr", "click", function () {
                $(currentInputText).val($(this).find("div:first").html());
        ...
        this.autocomplete = function (param) {
                ...
                switch (event.keyCode) {
                    case 40: //向下键
                        ...
                        if ($nextSiblingTr.length > 0) {//有下一行时（不是最后一行）
                            ...
                            $(node).val($nextSiblingTr.find("div:first").html()); //选中行内容设置到输入框中
                    ...
                    case 38: //向上键
                        ...
                        if ($previousSiblingTr.length > 0) {//有上一行时（不是第一行）
                            ...
                            $(node).val($previousSiblingTr.find("div:first").html()); //选中行内容设置到输入框中
            ...
            function makeContAndShow(data_) {
                ...
                for (var i = 0; i < data_.length; i++) {
                    cont += "<tr><td><div>" + data_[i].title + "</div></td><td><div>"+data_[i].result+"<div></td></tr>"
                }
                cont += "</tbody></table>";
