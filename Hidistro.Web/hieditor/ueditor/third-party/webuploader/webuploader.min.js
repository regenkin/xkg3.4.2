/* WebUploader 0.1.2 */ ! function (a, b) {
    ...
    return b("dollar-third", [], function () {
        ...
        return c.options = {}, b.installTo(c.prototype), d.each({
            ...
            movetoLeftFile: "move-toleftfile",
            movetoRightFile:"move-torightfile",
            skipFile: "skip-file",
            retry: "retry",
        ...
        return d.extend(b.options, {
            ...
            addButton: function (b) {
                var e, f, g, h = this,
                    i = h.options,
                    j = i.accept;
                if (b) return g = a.Deferred(), d.isPlainObject(b) || (b = {
                    id: b
                }), e = d.extend({}, b, {
                    accept: d.isPlainObject(j) ? [j] : j,
                    swf: i.swf,
                    runtimeOrder: i.runtimeOrder
                }), f = new c(e), f.once("ready", g.resolve), f.on("select", function (a) {
        ...
        return b.register({
            ...
            "move-toleftfile": "movetoLeftFile",
            "move-torightfile": "movetoRightFile",
            retry: "retry",
            reset: "reset",
            ...
            movetoLeftFile: function (a) {
                var b = this;
                if ($("#" + a.id).prev().html() == undefined) {
                    alert("已经是第一位！");
                    return;
                }
                var thiscontainer = $("#" + a.id);
                var prev = $("#" + a.id).prev();
                var cloneElment = thiscontainer.clone(true);
                thiscontainer.remove();
                cloneElment.insertBefore(prev);
            },
            movetoRightFile: function (a) {
                var b = this;
                if($($("#" + a.id).next()).attr("id")=="filePickerBlock"){
                    alert("已经是最后一位！");
                    return;
                }
                var thiscontainer = $("#" + a.id);
        ...
        return b.register("Transport", {
            ...
            send: function () {
                ...
                e.connectRuntime(f.ruid), c.sendAsBinary ? (g += (/\?/.test(g) ? "&" : "?") + d.param(b._formData), a = f.uid) : (d.each(b._formData, function (a, b) {
                    e.exec("append", a, b)
                }), e.exec("appendBlob", c.fileVal, f.uid, c.filename || b._formData.name || "")), this._setRequestHeader(e, c.headers), e.exec("send", {
                    method: c.method,
                    url: g
                }, a)
            },
