            ...
            function addFile(file) {
                var $li = $('<li id="' + file.id + '">' +
                    ...
                    $btns = $('<div class="file-panel">' +
                        ...
                        '<span class="rotateLeft">' + lang.uploadTurnLeft + '</span>' +
                        '<span class="movetoRight">右移</span><span class="movetoLeft">左移</span>' +
                        '</div>').appendTo($li),
                ...
                $btns.on('click', 'span', function () {
                    ...
                    switch (index) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            uploader.movetoRightFile(file);// file.rotation -= 90;
                            break;
                        case 4:
                            uploader.movetoLeftFile(file);// file.rotation -= 90;
                            break;
                    }
