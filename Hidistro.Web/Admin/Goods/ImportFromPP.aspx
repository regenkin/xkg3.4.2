<%@ Page Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ImportFromPP.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.ImportFromPP" Title="无标题页" %>
    ...
    <form runat="server">
        ...
        <div id="mytabl">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="ImportFromPP.aspx">从拍拍数据包导入</a></li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active">
                    <div class="set-switch">
                        <strong>数据包信息</strong>
                        <p>拍拍数据包的来源：1.系统本身导出的拍拍数据包；2.拍拍或商品助理导出的文件，把CSV文件和图片文件夹都命名为products然后选中两个打成zip的压缩包</p>
                    </div>
                    <div class="form-horizontal">
                        ...
                        <div style="margin-left: 176px">
                            <small class="help-block">请上传 *.zip 格式的数据包，上传数据包须小于40M，否则可能上传失败，<br />
                                您还可以使用FTP工具先将数据包上传到网站的/storage/data/paipai目录以后，再重新打开此页面操作。</small>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                ...
                                <small class="help-block">如果上面的下拉框中没有您要导入的数据包文件,请先上传。</small>
                            </div>
