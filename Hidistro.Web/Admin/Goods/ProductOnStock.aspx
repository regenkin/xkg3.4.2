<%@ Page Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true"
    CodeBehind="ProductOnStock.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.ProductOnStock" %>
            ...
            if (productIds.length > 0) {
                ...
                switch (Operation) {
                    case "1":
                        ...
                        $("#divOnSaleProduct").modal('toggle').children().css({
                            width: 500 + 'px',
                            height: 300 + 'px'
                        })
                        break;
        ...
        function StockZore() {
            ...
            $('.content-table input:checked').each(function () {
                ...
                if ($.trim(num) == "" || parseInt(num) == 0) {
                    HiTipsShow("您选择商品有库存为0或为空,不能上架！", 'fail');
                    b = false;
                }
            })
            return b;
        ...
        <div id="mytabl">
            ...
            <div class="table-page">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="ProductOnStock.aspx">
                                    ...
                                    <tr>
                                        <td colspan="8">
                                            <div class="mb10 table-operation">
                                                ...
                                                <button type="button" class="btn resetSize btn-primary" onclick="SelectOperation('1');">上架</button>
                                    ...
                                    <asp:Repeater ID="grdProducts" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td width="7%">
                                                    <p>
                                                        <a href="<%#"ProductEdit.aspx?productId="+Eval("ProductId")%>&reurl=<%=LocalUrl %>">编辑</a>
                                                        &nbsp; | &nbsp; <a href="<%#"ProductEdit.aspx?productId="+Eval("ProductId")%>&isnext=1&reurl=<%=LocalUrl %>">详情</a>
                                                    </p>
                                                    <p>
                                                        <asp:Button ID="btnUnSaleProduct" CommandName="UnSaleProduct" CommandArgument='<%# Eval("ProductId") %>' runat="server" CssClass="btnLink pad" Text="上架" OnClientClick="return HiConform('<strong>确定要上架所选商品吗？</strong><p>上架后商品将在前台显示！</p>',this);" />&nbsp;︱ 
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>
                                        确定要上架所选商品吗？上架后商品将在前台出售！
                                    </p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                                    <asp:Button ID="btnUpSale" runat="server" OnClientClick="return StockZore();" Text="上架商品" CssClass="btn btn-primary" />
                                </div>
                            </div>
                            <!-- /.modal-content -->
                        </div>
