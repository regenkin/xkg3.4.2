<%@ Page Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ExportToTB.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.ExportToTB" %>
    ...
    <form runat="server">
        ...
        <div id="mytabl">
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a href="#home">导出为淘宝数据包</a></li>
                    ...
                    <div class="form-inline">
                        ...
                        <div style="margin-top: 10px;">
                            ...
                            <div class="form-group" style="width:345px;">
                                ...
                                <div class="checkbox rsertRadio" style="width:215px;">
                                    <label style="width:97px;">
                    ...
                    <div style="margin-top: 10px;">
                        <div class="set-switch">
                            <div class="form-inline">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputName2">导出版本</label>
                            ...
                            <UI:Grid runat="server" ID="grdProducts" Width="100%" AllowSorting="true" ShowOrderIcons="true" GridLines="None" DataKeyNames="ProductId" CssClass="table table-bordered table-hover"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="库存" ItemStyle-Width="100">
                                        <ItemTemplate>
                                            <asp:Label ID="lblStock" runat="server" Text='<%# Eval("Stock") %>' Width="100"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="操作" ItemStyle-Width="80" HeaderStyle-CssClass=" td_left td_right_fff">
                                        <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="btnRemove" runat="server" CssClass="btn btn-primary" CommandName="Remove" Text="不导出" /> 
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </UI:Grid>
