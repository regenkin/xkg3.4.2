                                            ...
                                            <tr>
                                                <td width="30%">
                                                    ...
                                                    <div class="shop-info">
                                                        ...
                                                        <a title="点击复制商品链接" class="fz" href="javascript:void(0)" data-clipboard-target='urldata<%# Eval("ProductId") %>' id='url<%# Eval("ProductId") %>' onclick="copyurl(this.id);"></a>
                                                    </div>
                                                </td>
