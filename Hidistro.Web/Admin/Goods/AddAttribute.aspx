<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="AddAttribute.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.AddAttribute" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript" language="javascript">
        function gotourl()
        {
            ...
            location.href = "AddSpecification.aspx?typeId=" + getParam('typeId');
        }
    </script>
</asp:Content>
    ...
    <form runat="server">
        ...
        <div id="mytabl">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="#profile">第二步：添加扩展属性</a></li>
