<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="EditSpecification.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.EditSpecification" %>
     ...
     <div class="page-header">
        ...
        <div id="mytabl">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href='<%= Globals.GetAdminAbsolutePath("/Goods/EditSpecification.aspx?typeId=" + Page.Request.QueryString["typeId"])%>'>规 格</a></li>
