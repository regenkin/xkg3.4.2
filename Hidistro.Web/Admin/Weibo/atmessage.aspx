<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/AdminNew.Master" CodeBehind="atmessage.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Shop.AtMessage" %>
    ...
    <script>
        ...
        function SubmitReply() {
            if (addandedittype == "add") {
                ...
                var url = "&ArticleId=" + ArticleId + "&Type=3&Content=" + Content + "&ReplyKeyId=0&ReceiverType=" + ReceiverType + "&Display_name=" + Display_name + "&Summary=" + Summary + "&Image=" + Image + "&Url=" + Url;
                ...
                var Content = $("#txtContent").val();
                var url = "&ArticleId=" + ArticleId + "&Type=3&Content=" + Content + "&id=" + editid + "&ReplyKeyId=0&ReceiverType=" + ReceiverType + "&Display_name=" + Display_name + "&Summary=" + Summary + "&Image=" + Image + "&Url=" + Url;
        ...
        function setEnable(obj) {
            ...
            $.ajax({
                ...
                data: { type: "3", enable: enable, action: "setenable" },
                dataType: "text",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="page-header">
                    <h2>被@后自动回复</h2>
                    <small>说明：指定的认证用户需被授予接收“被@消息”权限，此接口才返回“被@消息”，申请可邮件 open_api@sina.com</small>
    </div>
    <form runat="server">
        <div class="app-init-container">
            <div id="mytabl">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="atmessage.aspx">被@后自动回复</a></li>
                    ...
                    <div class="tab-pane active">
                        <div style="position: relative; margin-bottom: 15px;">
                            <a data-popover-place="bottom" class="btn btn-success js-add-rule-group" href="javascript:;" data-toggle="popover" data-placement="bottom"
                                data-content="" data-container="body" onclick="addreply()">新增被@回复</a>
