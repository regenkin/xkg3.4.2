<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="usertimeline.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Shop.UserTimeline" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function loadStatuses(page) {
            $.getJSON("../../API/WeiBoAPI.ashx?action=usertimeline&page=" + page).done(function (d) {
                ...
                if (d.statuses) {
                    for (var i in d.statuses) {
                        ...
                        tpl.find('#wbtext').html(weiboHelper.FilterEmotionHtml(status.text.replace("alert", "Alert")));
