<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ExpressTemplates.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Trade.ExpressTemplates" %>
     ...
     <UI:Grid ID="grdExpressTemplates" runat="server" ShowHeader="true" AutoGenerateColumns="false" 
         DataKeyNames="ExpressId" HeaderStyle-CssClass="table_title" CssClass="table table-hover mar table-bordered"  GridLines="None" >
            <Columns>   
                ...
                <%--<UI:YesNoImageColumn DataField="IsDefault" HeaderText="默认模板" CommandName="IsDefault"  ItemStyle-CssClass="btn-xs _isdefault" HeaderStyle-Width="16%" HeaderStyle-CssClass="td_right" />  --%>                                                               
                <asp:TemplateField HeaderText="操作" ItemStyle-Width="25%" HeaderStyle-CssClass="td_right_fff">
                    ...
                    <span>
                        <%--<Hi:ImageLinkButton ID="lkDelete" Text="删除" IsShow="true" CssClass="btn btn-danger btn-xs"  CommandName="DeleteRow" runat="server" />--%>
                         <asp:Button ID="lkDelete" runat="server" Text="删除" IsShow="true" CommandName="DeleteRow" CssClass="btn btn-danger btn-xs"    OnClientClick="return HiConform('<strong>确定要删除选择的模板吗？</strong><p>删除模板不可恢复！</p>',this)" ToolTip="" /> 
                    </span>   
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
