<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecycleStation.aspx.cs" MasterPageFile="~/Admin/AdminNew.Master" Inherits="Hidistro.UI.Web.Admin.Trade.RecycleStation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="set-switch">
                        <div class="form-inline mb10">
                            <div class="form-group mr20">
                                ...
                                <asp:TextBox ID="txtOrderId" runat="server" PlaceHolder="订单号" CssClass="form-control resetSize inputw150" /><asp:Label ID="lblStatus"
                                    runat="server" Style="display: none;" ></asp:Label>
                            </div>
                            <div class="form-group mr20">
                                <label for="sellshop1">成交时间：</label>
                                <Hi:DateTimePicker CalendarType="StartDate" ID="calendarStartDate" runat="server" PlaceHolder="开始时间" CssClass="form-control resetSize inputw150" />
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                至&nbsp;&nbsp;&nbsp;
                                <Hi:DateTimePicker ID="calendarEndDate" runat="server" CalendarType="EndDate" PlaceHolder="结束时间" CssClass="form-control resetSize inputw150" />
                        ...
                        <div class="form-inline mb10">
                            <div class="form-group mr20">
                             ...
                             <div class="form-group mr20">
                                <label for="ctl00_ContentPlaceHolder1_txtShopName">店铺名称：</label>
                                <asp:TextBox ID="txtShopName" runat="server" CssClass="form-control resetSize inputw150" placeholder="店铺名称"/>
                            </div>
                            <div class="form-group mr20">
                                 <label for="ctl00_ContentPlaceHolder1_txtOrderState">订单状态：</label>
                                  <asp:DropDownList ID="ddrOrderStatus"  runat="server" Width="107" CssClass="form-control  resetSize  inputw120" >
                                    <asp:ListItem Text="所有订单" Value="0" Selected="True"></asp:ListItem>
                                    <asp:ListItem Text="等待付款" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="已付款" Value="2"></asp:ListItem>
                                      <asp:ListItem Text="已发货" Value="3"></asp:ListItem>
                                      <asp:ListItem Text="已关闭" Value="4"></asp:ListItem>
                                      <asp:ListItem Text="已完成" Value="5"></asp:ListItem>
                                      <asp:ListItem Text="申请退款" Value="6"></asp:ListItem>
                                      <asp:ListItem Text="申请退货" Value="7"></asp:ListItem>
                                      <asp:ListItem Text="申请换货" Value="8"></asp:ListItem>
                                      <asp:ListItem Text="已退款" Value="9"></asp:ListItem>
                                      <asp:ListItem Text="已退货" Value="10"></asp:ListItem>
                                </asp:DropDownList>
                                  <asp:Button ID="btnSearchButton" runat="server" class="btn resetSize btn-primary" style="margin-left:20px" Text="查询" />
                                <a class="mb5" onclick="resetform();" style="cursor: pointer;margin-left:30px">清除条件</a>
                            </div>
                        </div>
                    ...
                    <div class="form-horizontal fl">
                        <div class="form-group mar forced">
                            <div class="checkbox">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="btnRestoreCheck" runat="server" Text="批量还原" CssClass="btn btn-primary resetSize"  OnClientClick="return HiConform('<strong>还原订单</strong><p>订单还原后，可在所有订单中查看订单信息。</p>',this)" />
                               <%-- <asp:Button ID="btnDeleteCheck" runat="server" Text="彻底删除"  CssClass="btn btn-danger resetSize" OnClientClick="return HiConform('<strong>订单删除</strong><p>彻底删除后的订单将不能恢复，请确认是否继续？</p>',this)" />--%>
                                  <input type="button" runat="server" id="Button8" value="彻底删除" class="btn btn-danger resetSize" onclick="ShowDeleteOrders()" />
                            </div>
                        </div>
                    </div>
                    <div class="page fr">
                            ...
                            <li>
                                <div class="listTitle">
                                    <label>
                                        ...
                                        订单编号：<%#Eval("OrderId") %><%#Globals.GetBarginShow(Eval("BargainDetialId")) %></label>&nbsp;<span><Hi:FormatedTimeLabel ID="lblStartTimes" Time='<%#Eval("OrderDate") %>' ShopTime="true"
                                            runat="server"></Hi:FormatedTimeLabel></span>
                                  <span style="margin-left: 40px;">
                                      <asp:Literal ID="WeiXinNickName" runat="server"></asp:Literal>
                                        <%--<Hi:OrderStatusLabel ID="lblOrderStatus" OrderStatusCode='<%# Eval("DeleteBeforeState") %>'
                                            runat="server" />--%>
                                            ...
                                            <td width="470">
                                                <div class="listInfoRight clearfix">
                                                    <div class="paymentAmount fl">
                                                        <p>
                                                            <asp:Literal ID="litOtherInfo" runat="server"></asp:Literal></p>
                                                    </div>
                                                    ...
                                                    <div class="operation fr">
                                                       <%-- <a href="OrderDetails.aspx?OrderId=<%#Eval("OrderID") %>" target="_blank" class="btn btn-info resetSize inputw100 btnvieworders bl mb5">查看详情</a>
                                                        ...
                                                        <a href="RecycleStationDetail.aspx?OrderId=<%#Eval("OrderID") %>" target="_blank" class="btn btn-info resetSize inputw100 btnvieworders bl mb5" style="color: #fff;background-color: #5cb85c">查看详情</a>
                                                        <%#GetSpitLink(Eval("SplitState") ,Eval("OrderStatus"),Eval("OrderID")) %>
                                                         <asp:Button ID="btnRestore" runat="server" Text="还原" CssClass="btn btn-info resetSize inputw100 btnvieworders bl mb5"  CommandArgument='<%# Eval("OrderId") %>'  CommandName="restore" OnClientClick="return HiConform('<strong>还原订单</strong><p>订单还原后，可在所有订单中查看订单信息。</p>',this)" />
                                                        <%--<asp:Button ID="btnDelete" runat="server" Text="彻底删除"  CommandArgument='<%# Eval("OrderId") %>'  CommandName="delete" CssClass="btn btn-danger resetSize inputw100"  OnClientClick="return HiConform('<strong>订单删除</strong><p>彻底删除后的订单将不能恢复，请确认是否继续？</p>',this)" />--%>
                                                        <input type="button"  id="btnDeleteCheck" value="彻底删除" class="btn btn-danger resetSize inputw100" onclick="ShowDeleteOrder('<%# Eval("OrderId")%>')" />
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content form-horizontal">
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="btnCloseOrder" runat="server" CssClass="btn btn-success" Text="关闭订单" OnClientClick="return CheckCloseSel()" />
        ...
        <div class="modal fade" id="deleteConfirm">
            <div class="modal-dialog">
                <div class="modal-content form-horizontal">
                    ...
                    <div class="modal-body">
                           注意：删除订单后，系统自动更新当天的统计数据<br />
                          <%-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;选择<span style="color: #c9302c">“删除并更新”</span>，系统删除订单后自动更新当天的统计数据<br />
                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;选择<span style="color: #c9302c">“直接删除”</span>，系统直接删除订单但不会更新已有统计数据--%>
                    </div>
                    <div class="modal-footer">
                        <input type="hidden" value="" id="hiddOrderId" runat="server" />
                                                <asp:Button ID="btnDeleteAndUpdateData" runat="server" CssClass="btn btn-success" BackColor="#c9302c" BorderColor="#c9302c"  Text="确定删除"  />
                  <%--        <asp:Button ID="btnDeleteAndUpdateData" runat="server" CssClass="btn btn-success" BackColor="#c9302c" BorderColor="#c9302c"  Text="确定删除" OnClientClick="return HiConform('<strong>订单删除</strong><p>彻底删除后的订单将不能恢复，请确认是否继续？</p>',this)" />
                      <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-success" BackColor="#c9302c" BorderColor="#c9302c"   Text="直接删除" OnClientClick="return HiConform('<strong>订单删除</strong><p>彻底删除后的订单将不能恢复，请确认是否继续？</p>',this)" />--%>
                        <button type="button" class="btn btn-default" data-dismiss="modal">暂不删除</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function resetform() {
            ...
            window.location.href = "RecycleStation.aspx";
        }
                    ...
                    if (json.type == "1") {
                        if (json.allcount > 0) {
                            ...
                            if (json.buyalreadypaidcount > 0) {
                                $("#liOper2").find("span").html($("#liOper2").find("span").html() + "<em>(" + json.buyalreadypaidcount + ")</em>");
                            }
                            if (json.sellalreadysentcount > 0) {
                                $("#liOper3").find("span").html($("#liOper3").find("span").html() + "(" + json.sellalreadysentcount + ")");
                            }
                            if (json.finishedcount > 0) {
                                var text = $("#liOper5").find("span").text();
                                $("#liOper5").find("span").html($("#liOper5").find("span").html() + "(" + json.finishedcount + ")");
                            }
                            if (json.applyforreturnscount > 0) {
                                $("#liOper6").find("span").html($("#liOper6").find("span").html() + "<em>(" + json.applyforreturnscount + ")</em>");
                            }
                            if (json.closedcount > 0) {
                                $("#liOper4").find("span").html($("#liOper4").find("span").html() + "(" + json.closedcount + ")");
                            }
                        }
                    }
                    $(".nav.nav-tabs").show();
        ...
        function CloseOrderFun(orderId) {
            arrytext = null;
            formtype = "close";
            $("#ctl00_ContentPlaceHolder1_ddlCloseReason option:first").prop("selected", 'selected');
            $("#ctl00_ContentPlaceHolder1_hidOrderId").val(orderId);
        ...
        function CheckCloseSel() {
            var sel = $("#ctl00_ContentPlaceHolder1_ddlCloseReason").val();
            if (sel == "请选择关闭的理由") {
                ShowMsg(sel, false);
                return false;
            }
        ...
        function ShowDeleteOrder(orderId) {
            $("#ctl00_ContentPlaceHolder1_hiddOrderId").val(orderId);
        ...
        //批量删除订单
        function ShowDeleteOrders() {
            var orderIds = "";
            $("input:checked[name='CheckBoxGroup']").each(function () {
                orderIds += $(this).val() + ",";
            });
            if (orderIds == "") {
                ShowMsg("请选择要删除的订单", false);
                return;
            }
 
            $("#ctl00_ContentPlaceHolder1_hiddOrderId").val(orderIds);
