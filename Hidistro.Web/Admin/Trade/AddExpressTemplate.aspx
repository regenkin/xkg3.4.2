<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="AddExpressTemplate.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Trade.AddExpressTemplate" %>
				...
				margin:0px 0px 5px 0px;">
				  ...
				  <tr>
					...
					<td width="42" class="tdline"><form name="form3">
					  <label><button name="btndata" onClick="getData(1)" type="button" class="btn btn-info btn-xs">保存
							</button></label>
					</form></td>
