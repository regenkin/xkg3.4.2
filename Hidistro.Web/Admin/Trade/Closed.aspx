<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="Closed.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Trade.Closed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div id="mytabl">
            ...
            <div class="table-page">
                <ul class="nav nav-tabs" style="display: none">
                    <li id="liOper0">
                        <asp:HyperLink runat="server" NavigateUrl="Closed.aspx"><span>所有交易关闭</span></asp:HyperLink></li>
                    <li id="liOper1">
                        <asp:HyperLink runat="server" NavigateUrl="Closed.aspx?stype=1"><span>退货订单</span></asp:HyperLink></li>
                </ul>
            </div>
                                            ...
                                            <td width="470">
                                                <div class="listInfoRight clearfix">
                                                    ...
                                                    <div class="operation fr">
                                                        ...
                                                        <input value="删除订单" onclick="DelByOrderID('<%#Eval("OrderID") %>')"  class="btn btn-danger resetSize inputw100" type="button">
    ...
    <script type="text/javascript">
        ...
        function resetform() {
            ...
            window.location.href = "Closed.aspx?stype=<%=stype%>";
        }
        function ShowOrderState() {
            var status = "<%=stype%>";//$("#ctl00_ContentPlaceHolder1_lblStatus").html();
            $("#liOper" + status).attr("class", "active");
        }
        function DelByOrderID(orderid){
            $('input[type="checkbox"][value!="'+orderid+'"]').removeAttr("checked");
            $($('input[type="checkbox"][value="'+orderid+'"]')).click();
            $("#ctl00_ContentPlaceHolder1_btnDeleteCheck").click();
        }
                ...
                success: function (json) {
                    if (json.type == "1") {
                        if (json.closedcount > 0) {
                            $("#liOper0").find("span").html($("#liOper0").find("span").html() + "(" + json.closedcount + ")");
                            if (json.count1 > 0) {
