<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="SellerAlreadySent.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Trade.SellerAlreadySent" %>
        ...
        <div id="mytabl">
            ...
            <div class="table-page">
                <ul class="nav nav-tabs" style="display: none">
                    ...
                    <li id="liOper0">
                        <asp:HyperLink runat="server" NavigateUrl="SellerAlreadySent.aspx"><span>所有已发货订单</span></asp:HyperLink></li>
                    <li id="liOper1"><asp:HyperLink  runat="server" NavigateUrl="SellerAlreadySent.aspx?stype=1"><span>货到付款订单</span></asp:HyperLink></li>
                </ul>
            </div>
                ...
                <div class="form-horizontal fl">
                    <div class="form-group mar forced">
                        <div class="checkbox">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
<%--                            <input type="button" class="btn btn-info resetSize" value="指定物流" onclick="SetLogisticsOrSendGoods(0)" />--%>
...
<%--                            <input type="button" class="btn btn-success resetSize" value="批量发货" onclick="SetLogisticsOrSendGoods(1)" />
                            ...
                            <asp:Button ID="btnSelOrdersFinish" runat="server" CssClass="btn btn-warning resetSize" Text="批量确认收货" OnClientClick="return HiConform('<p><span style=color:red>所有选中的订单</span>将变为完成状态，确认该订单已收货吗？</p>',this);" OnClick="btnSelOrdersFinish_Click" />
                            <asp:Button ID="btnDeleteCheck" Visible="false" runat="server" Text="批量删除" CssClass="btn btn-danger resetSize" OnClientClick="return HiConform('<strong>订单删除后将进入订单回收站！</strong><p>确定要批量删除所选择的订单吗？</p>',this)" />
                        </div>
                    </div>
                </div>
                <div class="page fr">
                                            ...
                                            <td width="470">
                                                <div class="listInfoRight clearfix">
                                                    <div class="paymentAmount fl">
                                                        <p><asp:Literal ID="litOtherInfo" runat="server"></asp:Literal></p>
                                                    </div>
                                                    ...
                                                    <div class="operation fr">
                                                        ...
                                                        <a href="OrderDetails.aspx?OrderId=<%#Eval("OrderID") %>&type=showlogistic" target="_blank" class="btn btn-info resetSize inputw100 btnvieworders bl mb5">查看物流</a>
    ...
    <script type="text/javascript">
        ...
        function resetform() {
            ...
            window.location.href = "SellerAlreadySent.aspx?stype=<%=stype%>";
        }
                ...
                success: function (json) {
                    if (json.type == "1") {
                        if (json.sellalreadysentcount > 0) {
                            $("#liOper0").find("span").html($("#liOper0").find("span").html() + "(" + json.sellalreadysentcount + ")");
                            if (json.count1 > 0) {
