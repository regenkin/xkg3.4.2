<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="Finished.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Trade.Finished" %>
        ...
        <div id="mytabl">
            ...
            <div class="table-page">
                <ul class="nav nav-tabs" style="display: none">
                   ...
                   <li id="liOper0">
                        <asp:HyperLink runat="server" NavigateUrl="Finished.aspx"><span>所有交易成功</span></asp:HyperLink></li>
                   <li id="liOper1"><asp:HyperLink  runat="server" NavigateUrl="Finished.aspx?stype=1"><span>货到付款订单</span></asp:HyperLink></li>
                </ul>
            </div>
...
<%--                            <input type="button" class="btn btn-success resetSize" value="批量发货" onclick="SetLogisticsOrSendGoods(1)" />--%>&nbsp;︱
    ...
    <script type="text/javascript">
        ...
        function resetform() {
            ...
            window.location.href = "Finished.aspx?stype=<%=stype%>";
        }
                ...
                success: function (json) {
                    if (json.type == "1") {
                        if (json.finishedcount > 0) {
                            $("#liOper0").find("span").html($("#liOper0").find("span").html() + "(" + json.finishedcount + ")");
                            if (json.count1 > 0) {
