<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="WaitBuyerPay.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Trade.WaitBuyerPay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div id="mytabl">
            ...
            <div class="table-page">
                <ul class="nav nav-tabs" style="display: none">
                    <li id="liOper1">
                        <asp:HyperLink ID="hlinkAllOrder" runat="server"><span>所有待付款</span></asp:HyperLink></li>
                </ul>
            </div>
                    ...
                    <div class="form-horizontal fl">
                        <div class="form-group mar forced">
                            <div class="checkbox">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnConfirmSelPayment" runat="server" Text="批量确认付款" CssClass="btn btn-warning resetSize" OnClientClick="return HiConform('<strong><span style=color:red>所有选中的订单</span>将变为已付款状态，确认客户已付款？</strong><p>如果客户已经通过其他途径支付了订单款项，您可以使用此操作修改订单状态</p>',this);" />
                                <input type="button" class="btn btn-danger resetSize" value="批量关闭订单" onclick="CloseAllOrderFun()" />
                                                    ...
                                                    <asp:Repeater ID="rptSubList" runat="server" OnItemDataBound="rptSubList_ItemDataBound">
                                                        <ItemTemplate>
                                                            <div class="orderInfolist clearfix">
                                                                ...
                                                                <p class="fl orderP ">
                                                                   <%-- <Hi:OrderItemStatusLabel ID="lblOrderItemStatus" OrderStatusCode='<%# Eval("OrderItemsStatus") %>' runat="server" />--%>
    ...
    <script type="text/javascript">
        ...
        function resetform() {
            ...
            window.location.href = "WaitBuyerPay.aspx";
        }
        ...
        function CloseAllOrderFun() {
            ...
            $("#ctl00_ContentPlaceHolder1_hidOrderId").val("sel");
            $('#closeOrder').modal('toggle').children().css({
                width: '520px',
                height: '260px'
            })
