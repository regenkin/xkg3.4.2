<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ReturnsApply.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Trade.ReturnsApply" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">
                    ...
                    <div class="set-switch">
                        ...
                        <div class="form-inline">
                            <div class="form-group mr20">
                                ...
                                <a class=" mb5" href="returnsapply.aspx" style="cursor: pointer">清除条件</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="orderManagement">
            ...
            <div class="select-page nomarg clearfix hide">
                                            ...
                                            <td width="470">
                                                <div class="listInfoRight clearfix">
                                                    ...
                                                    <div class="operation fr">
                                                        <a href="OrderDetails.aspx?OrderId=<%#Eval("OrderID") %>#returnInfo" target="_blank" class="btn btn-info resetSize inputw100 btnvieworders bl mb5">售后审批</a>
