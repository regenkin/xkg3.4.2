<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ManageOrder.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Trade.ManageOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div id="mytabl">
            ...
            <div class="table-page">
                <ul class="nav nav-tabs" style="display: none">
                    ...
                    <li id="liOper2">
                        <asp:HyperLink ID="hlinkYetPay" runat="server"><span>待发货</span></asp:HyperLink></li>
                    <li id="liOper3">
                        <asp:HyperLink ID="hlinkSendGoods" runat="server"><span>已发货</span></asp:HyperLink></li>
                    <li id="liOper6">
                        <asp:HyperLink ID="hlinkRefund" runat="server"><span>退款中</span></asp:HyperLink></li>
                    <li id="liOper5">
                        <asp:HyperLink ID="hlinkTradeFinished" runat="server"><span>交易成功</span></asp:HyperLink></li>
                    <li id="liOper4">
                        <asp:HyperLink ID="hlinkClose" runat="server"><span>交易关闭</span></asp:HyperLink></li>
                    <li style="display: none">
                        <asp:HyperLink ID="hlinkHistory" runat="server"><span>历史订单</span></asp:HyperLink></li>
                </ul>
            </div>
                    ...
                    <div class="set-switch">
                        ...
                        <div class="form-inline">
                            <div class="form-group mr20">
                                ...
                                <asp:DropDownList runat="server" ID="ddlIsPrinted" Width="107" Visible="false" />
                        ...
                        <ItemTemplate>
                            <li>
                                <div class="listTitle">
                                    ...
                                    <span style="margin-left: 40px; width:100px;">
                                    ...
                                    <span class="ml10 logistics" tid="<%#Eval("ExpressCompanyAbb") %>"><%--物流公司：未指定--%></span>
    ...
    <script type="text/javascript">
        ...
        function resetform() {
            ...
            window.location.href = "manageorder.aspx";
        }
