<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopEdit.aspx.cs" MasterPageFile="~/Admin/AdminNew.Master" Inherits="Hidistro.UI.Web.Admin.Shop.ShopEdit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- diy css start-->
    <link rel="stylesheet" href="/Admin/Shop/Public/common.css" />
    <link rel="stylesheet" href="/Admin/Shop/Public/css/iconfont.css" />
 ...
 .g-flex{margin-left:2px}*/
        ...
        .ctrl-item-list-li .formitems .form-controls a{max-width: 115px;}
        .droplist-menu{left:-60px;}
    </style>
            ...
            <div class="content-right fl" style="border: none; padding: 0px;">
                ...
                <div class="app_inner_content">
                    <div class="drag-module">
                        <h5>拖动添加模块</h5>
                        <div class="drag-module-lists">
                            <ul class="clearfix">
                                <li data-type="4">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocnshangpin1" ></i>
                                        <p>商品</p>
                                    </div>
                                </li>
                                <li data-type="5">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocnshangpinliebiao"></i>
                                        <p>商品列表</p>
                                    </div>
                                </li>
                                <li data-type="6">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocnshangpinsousuo"></i>
                                        <p>商品搜索</p>
                                    </div>
                                </li>
                                <li data-type="10">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocnfengexian"></i>
                                        <p>分割线</p>
                                    </div>
                                </li>
                                <li data-type="11">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocnkongbai"></i>
                                        <p>辅助空白</p>
                                    </div>
                                </li>
                                <li data-type="9">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocnguanggao"></i>
                                        <p>图片广告</p>
                                    </div>
                                </li>
                                <li data-type="8">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocntupiandaohang"></i>
                                        <p>图片导航</p>
                                    </div>
                                </li>
                                <li data-type="13">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocnchuchuang"></i>
                                        <p>橱窗</p>
                                    </div>
                                </li>
                                <li data-type="14">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocnshiping"></i>
                                        <p>视频</p>
                                    </div>
                                </li>
                                <li data-type="12">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocncaidan"></i>
                                        <p>顶部菜单</p>
                                    </div>
                                </li>
                                <li data-type="2">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocnbiaoti"></i>
                                        <p>标题</p>
                                    </div>
                                </li>
                                <li data-type="1">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocnfuwenben"></i>
                                        <p>富文本</p>
                                    </div>
                                </li>
                                <li data-type="7">
                                    <div class="transition2">
                                        <i class="iconfont icon-iocnwenbendaohang"></i>
                                        <p>文本导航</p>
                                    </div>
                                </li>
                            </ul>
    ...
    <script type="text/j-template" id="tpl_diy_con_type1">
        ...
        <div class="members_con">
            <div class="fulltext" style="padding:10px 0"><#= HiShop.DIY.Unit.html_decode(content.fulltext) #></div>
        </div>
    </script>
    ...
    <script type="text/j-template" id="tpl_diy_con_type2">
        <div class="members_con"  style="margin:0">
            <section class="members_special <#= content.direction #> " style="background-color:<#=  content.bgcorlor #>;height:30px;" >
                <h2 class="j-title"  style="color:<#= content.ftcorlor #>;font-size: 14px;line-height:30px;">
                    <# if (content.pic != "") {#>
                    <img src="<#= content.pic #>" style="width:30px;height:30px;" />
                    <# } #>
                    <#= content.title #>
                </h2>
    ...
    <script type="text/j-template" id="tpl_diy_ctrl_type2">
        <div class="formitems">
            <label class="fi-name">标题名称：</label>
        ...
        <div class="formitems">
            <label class="fi-name">对齐方式：</label>
            <div class="form-controls">
                <div class="radio-group">
                    <label><input type="radio" name="direction" value="left" <# if(content.direction=="left"){ #>checked<# } #> >左对齐</label>
                    <label><input type="radio" name="direction" value="center" <# if(content.direction=="center"){ #>checked<# } #> >居中对齐</label>
                    <label><input type="radio" name="direction" value="right" <# if(content.direction=="right"){ #>checked<# } #>>右对齐</label>
                </div>
            </div>
        </div>
        <div class="formitems">
            ...
            <div class="form-controls clearfix">
                <div class="colorPicker fl" id="#j_clp_col_0" data-name="col_0" data-color="<#= content.bgcorlor #>" style="background-color:<#= content.bgcorlor #>">颜色选择</div>
                <p class="fl color9 mt3"></p>
                <span class="fi-help-text"></span>
            </div>
        </div>
        <div class="formitems">
            ...
            <div class="form-controls clearfix">
                <div class="colorPicker fl" id="#j_clp_col_1" data-name="col_1" data-color="<#= content.ftcorlor #>" style="background-color:<#= content.ftcorlor #>">颜色选择</div>
                <p class="fl color9 mt3"></p>
                <span class="fi-help-text"></span>
            </div>
        </div>
        <div class="formitems">
            <label class="fi-name">前导图片：</label>
            <div class="form-controls clearfix">
                <# if (content.pic == "") {#>
                <a class="imgicon mr5" href="javascript:void(0)">+</a>
                <# } else{ #>
                <img src="<#= content.pic #>" style="width:60px;hight:60px;" />    
                <# } #>
                <button class="imgicon-btn j-navModifyIcon">上传</button>
                <p class="color9 mt3">左对齐方式，图标才会显示在标题前面，请上传透明背景的png格式图标</p>
                <span class="fi-help-text"></span>
            </div>
        </div>
    </script>
        ...
        <div class="members_con">
            ...
            <section class="members_goodspic">
                <ul>
                    ...
                    <li class="mingoods">
                        <div class="b_mingoods_wrapper">
                            <a href=""><img src="/Admin/shop/Public/images/diy/goodsView1.jpg" width="100%"></a></span>
                            <span class="replace"><i></i> &yen;88.00<span class="original_price"><s>&yen;99.00</s></span>
                        </div>
                    </li>
                    <li class="mingoods">
                        <div class="b_mingoods_wrapper">
                            <a href=""><img src="/Admin/shop/Public/images/diy/goodsView2.jpg" width="100%"></a>
                            <span class="replace"><i></i> &yen;88.00<span class="original_price"><s>&yen;99.00</s></span></span>
                        </div>
                    </li>
                    <li class="mingoods">
                        <div class="b_mingoods_wrapper">
                ...
                <ul>
                    ...
                    <li class="biggoods">
                        ...
                        <section class="members_goodsimg_name rename">
                            ...
                            <a href="">大图商品名称</a>
                            <# } #>
                            <span><i></i> 88.00<span class="original_price">原价：<s>&yen;888</s></span></span>
                        </section>
                    </li>
                    <li class="biggoods">
            ...
            <section class="members_goodspic big_small">
                <ul>
                    ...
                    <li class="biggoods">
                        ...
                        <section class="members_goodsimg_name rename">
                            <a href="">大图商品名称</a>
                            <span><i></i> 88.00<span class="original_price">原价：<s>&yen;999</s></span></span>
                        </section>
                    </li>
                    <li class="mingoods">
                        <a href=""><img src="/Admin/shop/Public/images/diy/goodsView4.jpg" width="100%"></a>
                ...
                <ul>
                    ...
                    <li class="b_mingoods goods_even">
                        <div class="b_mingoods_wrapper">
                            ...
                            <p class="pic_box"><span class="pirce">&yen;88.00</span><span class="yj">&yen;99.0</span></p>
    ...
    <script type="text/j-template" id="tpl_diy_ctrl_type4">
        <div class="formitems">
            <label class="fi-name mt15">选择商品：</label>
        ...
        <div class="members_con">
            ...
            <section class="members_goodspic">
                <ul>
                    ...
                    <# _.each(content.goodslist,function(goods){ #>
                    <li class="mingoods">
                        <div calss="b_mingoods_wrapper" style="padding: 5px;border: 1px solid #E9E9E9;">
    ...
    <script type="text/j-template" id="tpl_diy_ctrl_type5">
        <div class="formitems">
            <label class="fi-name">商品排序：</label> 
            <div class="form-controls">
                <select name="secondPriority" class="j-priority select width200">
                    <option value="3" <# if(content.secondPriority==3){#>selected<#}#> >最热商品（销量从高到低）</option>
                    <option value="4" <# if(content.secondPriority==4){#>selected<#}#> >最新商品（上架从晚到早）</option>
                </select>
            </div> 
        </div>
        <div class="formitems">
            <label class="fi-name">显示数量：</label>
            <div class="form-controls">
                <div class="radio-group">
                    <label><input type="radio" name="goodsize" value="6" <# if(content.goodsize==6){ #>checked<# } #> >前6个商品</label>
                    <label><input type="radio" name="goodsize" value="12" <# if(content.goodsize==12){ #>checked<# } #> >前12个商品</label>
                    <label><input type="radio" name="goodsize" value="18" <# if(content.goodsize==18){ #>checked<# } #> >前18个商品</label>
                </div>
                <span class="fi-help-text"></span>
        ...
        <div class="formitems">
            <label class="fi-name">展现形式：</label> 
            <div class="form-controls">
                <div class="radio-group">
                    <label><input type="radio" name="layout" value="2" <# if(content.layout==2){ #>checked<# } #> >大图</label>
                    <label><input type="radio" name="layout" value="1" <# if(content.layout==1){ #>checked<# } #> >小图</label>
        ...
        <div class="formitems j-showplg">
            ...
            <div class="form-controls">
                <div class="checkbox-group bl mb10">
                    <label><input type="checkbox" name="showName" <# if(content.showName){ #>checked<# } #>  >显示商品名称</label>
                    <span class="color9">（小图中不显示商品名称）</span>
                </div>
                <div class="checkbox-group bl mb10">
                    <label><input type="checkbox" name="showPrice" <# if(content.showPrice){ #>checked<# } #> >显示商品销售价</label>
                </div>
                <div class="checkbox-group bl">
                    <label><input type="checkbox" name="showMaketPrice" <# if(content.showMaketPrice){ #>checked<# } #> >显示商品原价</label>
                </div>
                 <div class="checkbox-group" style=display:none;>
                    <label><input type="checkbox" name="showIco" <# if(content.showIco){ #>checked<# } #> ></label>
                </div>
            </div>
        </div>
    </script>
    ...
    <script type="text/j-template" id="tpl_diy_ctrl_type6">
      <div class="formitems pt5">
         <p>商品搜索模块可以加入到页面的任何位置，可以通过拖动或者点击上下箭头改变摆放位置。</p>
      </div>
    </script>
        ...
        <div class="members_con" >
            <section class="members_nav2">
                <ul>
                    ...
                    <# if(item.linkType){ #>
                    <li><a href="<#= item.link #>" style ="padding-left:0px;" ><#= item.showtitle #></a><b></b></li>
                    <#}else{#>
                    <li><a href="#" style ="padding-left:0px;" >请添加导航链接</a><b></b></li>
                    <#}#>
                    <# }) #>
                    <# }else{ #>
                    <li><a href="#" style ="padding-left:0px;" >请添加导航链接</a><b></b></li>
    ...
    <script type="text/j-template" id="tpl_diy_ctrl_type7">
        <ul class="ctrl-item-list">
            ...
            <li class="ctrl-item-list-li">
                <div class="formitems">
                    <label class="fi-name autow">标题：</label>
                    <div class="form-controls ml45">
                        <input type="text" name="title" class="input xlarge" value="<#= item.showtitle #>" maxlength="100">
                        <span class="fi-help-text"></span>
                    </div>
                </div>
                <div class="formitems">
                    <label class="fi-name autow">链接：</label>
                    <div class="form-controls ml45">
                        ...
                        <# } #>
                        <div class="droplist">
                            <a href="javascript:;" target="_blank" class="droplist-title j-droplist-toggle">
                                <# if(item.linkType==0 && item.linkType!=11){ #>
                                <span>请选择</span>
                                <#}else{#>
                                <span>修改</span>
                                <#}#>
                                <i class="iconfont gicon-chevron-down"></i>
                            </a>
            ...
            <# }) #>
            <li class="ctrl-item-list-add" title="添加">
                <a class="droplist-title" href="javascript:void(0)">
                    <i class="iconfont icon-iconfontjia"></i>
                    <span>增加一个导航</span>
                </a>
            </li>
        </ul>
    ...
    <script type="text/j-template" id="tpl_diy_ctrl_type8">
        <ul class="ctrl-item-list">
            ...
            <li class="ctrl-item-list-li clearfix">
                <div class="formitems imgmodule">
                    <div class="y-reset-img">
                        <div class="imgnav j-selectimg reset-position noborder" type="0">
                            <img src="<#= item.pic #>">
                            <span class="imgnav-reselect">重新选择</span>
                        </div>
                        <div class="ml90">
                            <div class="formitems">
                                <label class="fl autow pt3">标题：</label>
                                <div class="form-controls ml0 fl">
                                    <input type="text" name="title" placeholder="标题可以不设置" class="input xlarge mb0" value="<#= item.showtitle #>" maxlength="100" style="height:auto;">
                                    <span class="fi-help-text"></span>
                                </div>
                            </div>
                         

                            <div class="formitems pb0">
                                <label class="fl mb0 mt3">链接：</label>
                                    <# if(item.linkType  && item.linkType!=11){ #>
                                    <a href="<#= item.link #>" target="_blank" class="badge badge-success fl" title="<#= item.title #>">
                                        <span><#= HiShop.linkType[item.linkType] #></span>
                                        <em class="badge-link ovfEps"><#= item.title #></em>
                                    </a>
                                    <#}#>
                                    ...
                                    <# if(item.linkType==11){ #>
                                    <input type="text" name="customlink" class="input xlarge mb0 autow fl" value="<#= item.link #>">
                                    <# } #>
                                    <div class="form-controls fl ml0">
                                        <div class="droplist">
                                            <a href="javascript:;" class="droplist-title j-droplist-toggle ">
                                                ...
                                                <span>修改</span>
                                                <#}#>
                                                <i class="iconfont gicon-chevron-down mgl5"></i>
                                            </a>
                                            <ul class="droplist-menu">
                                            <li data-val="1"><a href="javascript:;"><#= HiShop.linkType[1] #></a></li>
                                            <li data-val="2"><a href="javascript:;"><#= HiShop.linkType[2] #></a></li>
                ...
                <div class="ctrl-item-list-actions">
                    <a class="iconfont icon-iconfontcolor84 colorl j-moveup"  href="javascript:;"></a>
                    <a class="iconfont icon-iconfontcolor83 colorl j-movedown"  href="javascript:;"></a>
                    <a class="iconfont icon-guanbi colorr fr pt2 ml3 mr10 j-del"  href="javascript:;"></a>
                </div>
            </li>
            <# }) #>
        ...
        <div class="members_con" style="margin:<# if(content.space == 1){ #>10px auto<# }else{ #>0 auto<# } #>">
            ...
            <section class="members_flash j-swipe" id="mySwipe">
                <ul class="clearfix">
                    ...
                    <# }else{ #>
                    <li><a href="" title=""><img src="/Admin/Shop/Public/images/diy/imgad.jpg" width="100%" /></a></li>
                    <# } #>
                </ul>
    ...
    <script type="text/j-template" id="tpl_diy_ctrl_type9">
            ...
            <div class="formitems pb0">
                <label class="fi-name">显示形式：</label>
                <div class="form-controls">
                    <div class="radio-group">
                        <label><input type="radio" name="showType" value="1" <# if(content.showType==1){ #>checked<# } #> >折叠轮播</label>
                        <label><input type="radio" name="showType" value="2" <# if(content.showType==2){ #>checked<# } #> >上下平铺</label>
                    </div>
                </div>
            </div>
            <div class="formitems pb0 mb10">
                <label class="fi-name">设置图片：</label>
                <div class="form-controls">
                    <p class="color9 pt8">建议图片最大宽度不超过640px</p>
                </div>
            </div>
            <# if(content.showType==2){ #>
            <div class="formitems inline">
                <label class="fi-name">图片上下距离：</label>
                <div class="form-controls">
            ...
            <# } #>
            <ul class="ctrl-item-list ml40">
                <# _.each(content.dataset,function(item){ #>
                <li class="ctrl-item-list-li clearfix">
                    <div class="formitems imgmodule">
                        <div class="y-reset-img">
                            <div class="imgnav j-selectimg reset-position" type="0">
                                <# if(item.pic && item.pic!=""){ #>
                                <img src="<#= item.pic #>">
                                <span class="imgnav-reselect">重新选择</span>
                                <# }else{ #>
                                <span class="imgnav-select">选择图片</span>
                                <# } #>
                            </div>
                            <div class="ml90">
                                <div class="formitems">
                                    <label class="fl autow pt3">标题：</label>
                                    <div class="form-controls ml0 fl width150">
                                        <input type="text" name="title" class="input xlarge mb0 autow" value="<#= item.showtitle #>" placeholder="标题可以不设置" maxlength="100" style="height:auto;">
                                        <span class="fi-help-text"></span>
                                    </div>
                                </div>
                                <!--<p class="color9">标题可以不设置，不设置标题时图片上不显示标题内容</p>-->
                                <div class="formitems pb0">
                                    <label class="fl mb0 mt3">链接：</label>
                                    <# if(item.linkType  && item.linkType!=11){ #>
                                    <a href="<#= item.link #>" target="_blank" class="badge badge-success fl" title="<#= item.title #>">
    ...
    <script type="text/j-template" id="tpl_diy_con_type10">
        <div class="members_con">
            <section class="custom-line-wrap"><hr class="<#= content.styleClass #>" style="border-color:<#= content.corlor #>" ></section> 
    ...
    <script type="text/j-template" id="tpl_diy_ctrl_type10">
          <div class="formitems">
                <label class="fi-name">颜色：</label>
                <div class="form-controls">
                    <div class="colorPicker" id="#j_clp_col_0" data-name="col_0" data-color="<#= content.corlor #>" style="background-color:<#= content.corlor #>">颜色选择</div>
                    <span class="fi-help-text"></span>
                </div>
            </div>
            <div class="formitems pb0">
                <label class="fi-name">样式：</label>
                <div class="form-controls">
                    <div class="radio-group">
                        <label><input type="radio" name="style" value="0" <# if(content.style==0){ #>checked<# } #> >虚线</label>
                        <label><input type="radio" name="style" value="1" <# if(content.style==1){ #>checked<# } #> >实线</label>
                    </div>
                </div>
            </div>
    </script>
    ...
    <script type="text/j-template" id="tpl_diy_ctrl_type12">
        <div class="formitems">
            <label class="fi-name" style="width:100px;">菜单格式：</label>
            <div class="form-controls">
                <div class="radio-group">
        ...
        <div class="formitems">
            <label class="fi-name" style="width:100px;">菜单间距：</label>
            <div class="form-controls">
                <div class="radio-group">
                    <label><input type="radio" name="marginstyle" value="0" <# if(content.marginstyle == 0||!content.marginstyle){ #>checked<# } #>>无间距</label>
                    <label><input type="radio" name="marginstyle" value="1" <# if(content.marginstyle == 1){ #>checked<# } #> >有间距</label>
                </div>
            </div>
        </div>
        <div class="formitems">
            <label class="fi-name" style="width:100px;">设置菜单：</label>
        </div>
            ...
            <li class="ctrl-item-list-li">
                ...
                <div class="formitems">
                    ...
                    <div class="form-controls clearfix">
                        ...
                        <# } else { #>
                        <a class="imgicon mr5 j-navModifyIcon" href="javascript:void(0)">+</a>
                        <# } #>
                        <button class="imgicon-btn j-uploadIcon">修改</button>
                ...
                <div class="formitems">
                    <label class="fi-name">背景颜色：</label>
                    <div class="form-controls clearfix">
                        <div class="colorPicker fl" id="#j_clp_col_<#= item.cloPicker #>" data-name="col_<#= item.cloPicker #>" data-color="<#= item.bgColor #>" style="background-color:<#= item.bgColor #>">颜色选择</div>
                        <p class="fl color9 mt3"></p>
                        <span class="fi-help-text"></span>
                    </div>
                </div>
    ...
    <script type="text/j-template" id="tpl_diy_ctrl_type13">
            <div class="formitems">
                ...
                <div class="form-controls">
                    <div class="radio-group">
                        <label><input type="radio" name="layout" value="0" <# if(content.layout==0){ #>checked<# } #>>2列，一大两小</label>
                        <label><input type="radio" name="layout" value="1" <# if(content.layout==1){ #>checked<# } #>>3列，三小图</label>
                    </div>
                </div>
            </div>
            <div class="formitems pb0 mb10">
                <label class="fi-name">设置图片：</label>
                <div class="form-controls">
                    <p class="color9 pt8">一大两小模式，左侧大图建议比例142x296px，小图149x144px</p>
                </div>
            </div>
            <ul class="ctrl-item-list">
                <# _.each(content.dataset,function(item){ #>
                <li class="ctrl-item-list-li clearfix pt15">
                    <div class="formitems imgmodule">
                        <div class="y-reset-img">
                            <div class="imgnav j-selectimg reset-position noborder" type="0">
                                <# if(item.pic && item.pic!=""){ #>
    ...
    <script type="text/j-template" id="tpl_diy_ctrl_type14">
        <div class="formitems inline">
            ...
            <div class="form-controls">
                <div class="diy-videowebsite">
                    <input class="width250" type="text" name="" value="<#= content.website#>" placeholder="">
                    <a href="javascript:;" title="确定视频地址" class="btn btn-primary j-getvideo">确定</a>
                </div>
                <p class="color9">目前只支持腾讯视频，请填写完整的带有vid或者sid的视频地址，如：http://v.qq.com/cover/****.html?vid=g0da0537fm</p>
            </div>
        </div>
    </script>
    <!-- type14 video end-->
        ...
        <div id="GoodsAndGroupPicker">
            ...
            <div class="tabs-content" data-origin="goodsandgroup">
                <div class="tc" data-index="1">
                    ...
                    <div class="clearfix mgt10" style="text-align: center;">
                        <div class="fr">
                            <a href="javascript:;" class="btn btn-primary j-btn-goodsuse">确定使用</a>
                        </div>
                        <div class="paginate pt0" style="display:inline-block"></div>
                    </div>
                </div>
                <div class="tc hide" data-index="2">
    ...
    <script type="text/j-template" id="tpl_albums_main">
        ...
        <div class="fr">
                    ...
                    <div class="albums-cr-ctrls clearfix">
                        <div class="paginate fr pt0" id="j-panelPaginate"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/j-template" id="tpl_materialPicker_single_table">
        ...
        <div class="clearfix mgt15">
            <div class="paginate fr pt0"><#= page #></div>
        </div>
    </script>
    ...
    <script src="/Admin/shop/Public/plugins/diy/diy.goods.js"></script>
    ...
    <script src="/Admin/shop/Public/plugins/diy/diy.eventsNew.js"></script>
    ...
    <script src="/Admin/shop/Public/plugins/diy/diy.drawg.js"></script>
    <script>
    ...
    <script>
        ...
        $(function () {
            ...
            var dragModuleTop = $('.drag-module').offset().top;
            $(window).scroll(function () {
                //alert($(document).scrollTop())
                if ($(document).scrollTop() >= dragModuleTop) {
                    $('.drag-module').css({
                        'position': 'fixed',
                        'top': '70px',
                        'left': 'auto'
