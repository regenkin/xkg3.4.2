...
$(function () {
    ...
    //模块类型3 自定义模块
    HiShop.DIY.Unit.verify_type3 = function (data) {
        var ctrlVisible = false,//控制内容是否为显示状态
			modulePassed = true;
        ...
        if (!data.content) {
            ...
            HiShop.FormShowError(ele, "请选择一个自定义模块");
        }
    ...
    //模块类型7 文本导航
    HiShop.DIY.Unit.verify_type7 = function (data) {
        var ctrlVisible = false,//控制内容是否为显示状态
			modulePassed = true;
    ...
    //模块类型8 图片导航
    HiShop.DIY.Unit.verify_type8 = function (data) {
        var ctrlVisible = false,//控制内容是否为显示状态
			modulePassed = true;
    ...
    //模块类型9 图片广告
    HiShop.DIY.Unit.verify_type9 = function (data) {
        var ctrlVisible = false,//控制内容是否为显示状态
			modulePassed = true;
