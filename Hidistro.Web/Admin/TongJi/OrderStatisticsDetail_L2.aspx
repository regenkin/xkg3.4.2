<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" 
    AutoEventWireup="true" CodeBehind="OrderStatisticsDetail_L2.aspx.cs" 
    Inherits="Hidistro.UI.Web.Admin.Sales.OrderStatisticsDetail_L2" %>
...
<%--                                <button type="submit" class="btn resetSize btn-primary">查询</button>--%>
                ...
                <div>
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" ><a href='OrderStatisticsDetail.aspx?UserId=<%= UserId %>'  >
                            一级分店</a></li>
                        <li role="presentation" class="active"><a href='OrderStatisticsDetail_L2.aspx?UserId=<%= UserId %>'   >
                            二级分店</a></li>
                    </ul>
