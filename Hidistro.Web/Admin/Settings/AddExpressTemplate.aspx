<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="AddExpressTemplate.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Settings.AddExpressTemplate" %>
    ...
    <div >
				...
				margin:0px 0px 5px 0px;">
				  ...
				  <tr>
					...
					<td width="42" class="tdline"><form name="form3">
					  <label><button name="btndata" onClick="getData()" type="button" class="btn btn-info btn-xs">保存
							</button></label>
					</form></td>
				...
				<div id="flashoutput">
					<noscript>
						...
						<embed name="flexApp" pluginspage="http://www.macromedia.com/go/getflashplayer" src="../../Storage/master/flex/AddExpressTemplate.swf" height="600" width="100%" wmode="transparent" flashvars="bridgeName=example"/>
						</object>
					</noscript>
					<script type="text/javascript" language="javascript" charset="utf-8">
					    ...
					    document.write('<embed name="flexApp" pluginspage="http://www.macromedia.com/go/getflashplayer" src="../../Storage/master/flex/AddExpressTemplate.swf" height="600" wmode="transparent" width="100%" flashvars="bridgeName=example"/>');
