<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ConcernUrl.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AliFuwu.ConcernUrl" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="set-switch">
        <strong>提示</strong>
        <p>开启以后，会员可以通过首页面板的关注链接来关注您的服务窗。<%--<a href="../help/yijianguanzhu.html" target="_blank" class="ml20">开启指引</a>--%></p>
    ...
    <form id="form1" runat="server" class="form-horizontal">
        <div class="form-group">
            <label class="col-xs-2 control-label resetSize"><strong>关注引导页面地址：</strong></label>
            <div class="col-xs-5">
