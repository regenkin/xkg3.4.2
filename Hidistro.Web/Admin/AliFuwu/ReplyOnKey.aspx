<%@ Page Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ReplyOnKey.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AliFuwu.ReplyOnKey" %>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <span class="submit_shanchu">
                                <Hi:ImageLinkButton ID="lkDelete" Text="删除" IsShow="true" CommandName="Delete" runat="server"  CommandArgument='<%#Eval("Id") %>'/></span></td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                        </tbody>
