<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="SendAllList.aspx.cs" Inherits="Hidistro.UI.Web.Admin.WeiXin.SendAllList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-inline mb10">
        <div class="form-group">
            <a class="btn btn-success resetSize" href="sendalledit.aspx">微信群发</a>
        </div>
    </div>
    <div class="datalist">
        <form runat="server">            
