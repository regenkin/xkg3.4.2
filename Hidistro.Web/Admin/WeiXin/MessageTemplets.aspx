<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" 
    CodeBehind="MessageTemplets.aspx.cs" Inherits="Hidistro.UI.Web.Admin.WeiXin.MessageTemplets" %>
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="home">
                            ...
                            <div class="y-tabinerboxsame mt20 mb20 pl20"  >
                                <a class="btn btn-success bindingmicrochannel">绑定运营者微信</a>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                       ...
                                                       <td><%#Eval("RoleName") %></td>
                                                        <td>
                                                            <ul class="clearfix">
                                                                <%--//固定列含义：1:新订单  2：订单付款  3：退款申请  4：用户咨询  5：提现申请   6：分销商申请成功--%>
                            ...
                            <p class="y-textborderleft">微信消息模板ID设置<a href="../WeiXin/weixinSettings.html" target="_blank">如何获得微信消息模板ID？</a></p>
...
<%--<div  role="dialog" aria-labelledby="mySmallModalLabel" id="myModal">--%>
            ...
            <div class="modal-content" id="divMiddle">
                <div class="w-modalbox">
                    ...
                    <div class="y-wechatstep">
                        <ul class="clearfix">
                            <li class="triangle active clearfix"  id="liStep1">1&nbsp;绑定微信号</li>
                    ...
                    <div class="wechatstepcontentbox">
                        <div class="wechatstepcontent active">
                            ...
                            <p class="mt10 mb5" style="color:#999999;font-size:12px;">openid号可以在<a href="../member/managemembers.aspx" target="memberList" >会员列表</a>中指定的会员一栏中查看并复制；</p>
...
<script type="text/javascript">
    ...
    $('#aMessageSet').click(function (e) {
        ...
        $("#tbTemplatesList").find("input[type='text']").each(function () {
            if ($(this).val().trim() == "") {
                NotSetCount++;
                ShowMsg("微信消息模板ID设置未完成，无法进行当前操作。", false);
    ...
    function SearchOpenID() {
        ...
        $.ajax({
            url: "/api/VshopProcess.ashx",
            type: "post",
            data: "action=getqrcodescaninfo&AppID=" + AppID + "&Ticket=" + CodeTicket,
            datatype: "json",
            async: false,//ty
            success: function (json) {
                //alert("成功返回了扫描信息。。。");
