<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddProductToPointExchange.aspx.cs"
    MasterPageFile="~/Admin/AdminNew.Master" Inherits="Hidistro.UI.Web.Admin.promotion.AddProductToPointExchange" %>
    ...
    <form id="thisForm" runat="server" class="form-horizontal">
        ...
        <div class="table-page">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li id="tabHeader_2" role="presentation" class="active">
