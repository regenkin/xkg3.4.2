<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true"
    CodeBehind="AddGameDaFuWen.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.AddGameDaFuWen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="thisForm" runat="server" class="form-horizontal">
                ...
                <div class="mobile-border">
                    <div class="mobile-d">
                        ...
                        <div class="set-overflow">
                            <div class="white-box resetH" style="background-color: #CB1200;">
                                <div class="topimg" style="background: url(../images/dafuwenpic1.png) no-repeat;
                                ...
                                <div class="bottomimg" style="background: url(../images/dafuwenpic.png) no-repeat;
                                    width: 290px; height:266px; margin: 0 auto;">
                                </div>
        ...
        <div id="btnSubmit" style="display: none;" class="footer-btn navbar-fixed-bottom">
            <a href="GameDaFuWenLists.aspx" class="btn btn-primary">完成</a>
        </div>
    </form>
</asp:Content>
