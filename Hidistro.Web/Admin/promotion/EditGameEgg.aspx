<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="EditGameEgg.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.EditGameEgg" %>
                    ...
                    <div class="mobile-d">
                        ...
                        <div class="set-overflow">
                            <div class="white-box resetH" style="background-color: #F55E6B;">
                                <div class="topimg" style="background: url(../images/eggpic1.png) no-repeat; background-size: 100%;
                                    width: 276px; height: 177px; margin: 0 auto;"></div>
                                  ...
                                  <div class="bottomimg" style="background: url(../images/eggpic.png) no-repeat; width: 290px;height:246px;
                                    margin: 0 auto;">
                                </div>
