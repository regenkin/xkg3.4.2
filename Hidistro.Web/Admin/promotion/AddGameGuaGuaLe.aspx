<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="AddGameGuaGuaLe.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.AddGameGuaGuaLe" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="thisForm" runat="server" class="form-horizontal">
                ...
                <div class="mobile-border">
                    <div class="mobile-d">
                        ...
                        <div class="set-overflow">
                            <div class="white-box resetH" style="background-color: #FF3B3C;">
                                <div class="topimg" style="background: url(../images/guaguakapic.png) no-repeat; background-size: 100%; width: 276px; height: 177px; margin: 0 auto;">
                                </div>
                                ...
                                <div class="bottomimg" style="background: url(../images/guajiangpic1.png) no-repeat; width: 290px;height: 180px;background-size: 100%; margin: 0 auto;">
                                </div>
        ...
        <div id="btnSubmit" style="display: none;" class="footer-btn navbar-fixed-bottom">
            <a href="GameGuaGuaLeLists.aspx" class="btn btn-primary">完成</a>
        </div>
    </form>
</asp:Content>
