<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true"
    CodeBehind="AddGameEgg.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.AddGameEgg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="thisForm" runat="server" class="form-horizontal">
                    ...
                    <div class="mobile-d">
                        ...
                        <div class="set-overflow">
                            <div class="white-box resetH" style="background-color: #F55E6B;">
                                <div class="topimg" style="background: url(../images/eggpic1.png) no-repeat;background-size:85%; width:276px;height:177px;margin:10px 0 0 40px;"></div>
                                 <div class="gamePrizes" id="DivGameNum" style="text-align:center;padding-top:30px;">  
                                    <p id="pGameNum">
                                       您还有<asp:Label ID="lbGameNum" runat="server" ForeColor="White"  Text=""></asp:Label>次机会
                                    </p>
                                </div>
                                <div class="bottomimg" style="background: url(../images/eggpic.png) no-repeat; width: 290px;height:246px;margin: 0 auto;"></div>
        ...
        <div id="btnSubmit" style="display: none;" class="footer-btn navbar-fixed-bottom">
            <a href="GameEggLists.aspx" class="btn btn-primary">完成</a>
        </div>
    </form>
</asp:Content>
