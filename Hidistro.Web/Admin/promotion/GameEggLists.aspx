<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="GameEggLists.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.GameEggLists" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="thisForm" runat="server" class="form-horizontal">
        ...
        <div class="blank">
            <a href="AddGameEgg.aspx" class="btn btn-primary">新建<%=PGameType.ToString() %></a>
        </div>
