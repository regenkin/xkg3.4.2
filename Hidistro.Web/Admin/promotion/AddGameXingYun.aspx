<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="AddGameXingYun.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.AddGameXingYun" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="thisForm" runat="server" class="form-horizontal">
                ...
                <div class="mobile-border">
                    <div class="mobile-d">
                        ...
                        <div class="set-overflow">
                            <div class="white-box resetH" style="background-color: #F55E6B;">
                                <div class="topimg" style="background: url(../images/fanpai-toubupic1.png) no-repeat;
                                    background-size: 100%; width: 276px; height: 177px; margin: 0 auto;">
                                </div>
                                 <div class="gamePrizes" id="DivGameNum" style="text-align:center;padding-top:10px;">  
                                    <p id="pGameNum">
                                       您还有<asp:Label ID="lbGameNum" runat="server" ForeColor="White"  Text=""></asp:Label>次机会
                                    </p>
                                </div>
                                <div class="bottomimg" style="background: url(../images/fanpaipic.png) no-repeat;
                                    width: 290px; height:380px; margin: 0 auto;">
                                </div>
                                ...
                                <div class="gamePrizes">
                                    ...
                                    <p id="pGameDescription">
                                        <asp:Label ID="lbGameDescription" runat="server" Text=""></asp:Label></p>
                                </div>
                                <div class="gamePrizes">
                                    <h3>活动时间：</h3>
                                    <p>
        ...
        <div id="btnSubmit" style="display: none;" class="footer-btn navbar-fixed-bottom">
            <a href="GameXingYunLists.aspx" class="btn btn-primary">完成</a>
        </div>
    </form>
</asp:Content>
