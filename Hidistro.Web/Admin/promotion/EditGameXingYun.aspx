<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="EditGameXingYun.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.EditGameXingYun" %>
                    ...
                    <div class="mobile-d">
                        ...
                        <div class="set-overflow">
                            <div class="white-box resetH" style="background-color: #F55E6B;">
                                <div class="topimg" style="background: url(../images/fanpai-toubupic1.png) no-repeat; background-size: 100%; width: 276px; height: 177px; margin: 0 auto;">
                                </div>
                                ...
                                <div class="bottomimg" style="background: url(../images/fanpaipic.png) no-repeat; width: 290px; height: 380px; margin: 0 auto;">
                                </div>
