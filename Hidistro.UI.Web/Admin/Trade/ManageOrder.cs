...
namespace Hidistro.UI.Web.Admin.Trade
{
	public class ManageOrder : AdminPage
	{
		...
		protected ManageOrder() : base("m03", "ddp03")
		{
		}
		...
		{
			string format = "ManageOrder.aspx?orderStatus={0}";
			this.hlinkAllOrder.NavigateUrl = string.Format(format, 0);
			this.hlinkNotPay.NavigateUrl = "WaitBuyerPay.aspx";
			this.hlinkYetPay.NavigateUrl = "BuyerAlreadyPaid.aspx";
			this.hlinkSendGoods.NavigateUrl = "SellerAlreadySent.aspx";
			this.hlinkClose.NavigateUrl = "Closed.aspx";
			this.hlinkTradeFinished.NavigateUrl = "Finished.aspx";
			this.hlinkHistory.NavigateUrl = string.Format(format, 99);
			this.hlinkRefund.NavigateUrl = "returnsapply.aspx";
		}
