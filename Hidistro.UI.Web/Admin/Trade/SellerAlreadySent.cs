...
{
	public class SellerAlreadySent : AdminPage
	{
		...
		protected System.Web.UI.WebControls.Button btnSelOrdersFinish;
		...
		protected SellerAlreadySent() : base("m03", "ddp05")
		{
		}
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			else if (a == "GetOrdersStates")
			{
				...
				int num2 = allOrderID.Select("OrderStatus=" + 3).Length;
				int num3 = allOrderID.Select("OrderStatus=" + 3 + " and Gateway = 'hishop.plugins.payment.podrequest'").Length;
				string s = string.Concat(new object[]
				{
					"{\"type\":\"1\",\"sellalreadysentcount\":",
					num2,
					",\"count1\":",
					num3,
					"}"
		...
		private OrderQuery GetOrderQuery()
		{
			...
			if (this.stype == 1)
			{
				orderQuery.Gateway = "hishop.plugins.payment.podrequest";
			}
