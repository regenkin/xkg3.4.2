			...
			if (orderInfo != null)
			{
				...
				else
				{
					if (e.CommandName == "delete")
					{
						...
						text = "'" + text.Replace(",", "','") + "'";
						int num3 = OrderHelper.RealDeleteOrders(text);
						this.BindOrders();
						this.ShowMsg(string.Format("成功删除了{0}个订单", num3), true);
						return;
					}
					if (e.CommandName == "restore")
					{
						...
						text2 = "'" + text2.Replace(",", "','") + "'";
						int num4 = OrderHelper.RestoreOrders(text2);
						this.BindOrders();
						this.ShowMsg(string.Format("成功还原了订单", num4), true);
					}
				}
			}
		}
