...
{
	public class OrderStatisticsDetail_L2 : AdminPage
	{
		...
		protected OrderStatisticsDetail_L2() : base("m10", "tjp02")
		{
		}
		...
		protected void btnSearch_Click(object sender, System.EventArgs e)
		{
			...
			{
				this.BeginDate = new System.DateTime?(this.txtBeginDate.SelectedDate.Value);
			}
			if (this.txtEndDate.SelectedDate.HasValue)
			{
				this.EndDate = new System.DateTime?(this.txtEndDate.SelectedDate.Value);
			}
			this.lastDay = 0;
		...
		private void LoadParameters()
		{
			if (!this.Page.IsPostBack)
			{
				...
				this.txtBeginDate.SelectedDate = this.BeginDate;
				this.txtEndDate.SelectedDate = this.EndDate;
