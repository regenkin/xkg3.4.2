	...
	public class MemberRanking : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!base.IsPostBack)
			{
				...
				this.exportFieldsCheckBoxList.Items.Add(new System.Web.UI.WebControls.ListItem("手机号", "CellPhone"));
				this.exportFieldsCheckBoxList.Items.Add(new System.Web.UI.WebControls.ListItem("用户名", "UserName"));
				this.exportFieldsCheckBoxList.Items.Add(new System.Web.UI.WebControls.ListItem("注册日期", "CreateDate"));
				this.exportFieldsCheckBoxList.Items.Add(new System.Web.UI.WebControls.ListItem("订单数", "OrderNumber"));
				this.exportFieldsCheckBoxList.Items.Add(new System.Web.UI.WebControls.ListItem("消费额", "OrderTotal"));
				this.exportFieldsCheckBoxList.Items.Add(new System.Web.UI.WebControls.ListItem("客单价", "AvgPrice"));
			}
		}
		...
		private void btnExport_Click(object sender, System.EventArgs e)
		{
			...
			System.Data.DataTable dataTable = ShopStatisticHelper.Member_GetStatisticReport_NoPage(new OrderStatisticsQuery
			{
		...
		private void BindData()
		{
			...
			orderStatisticsQuery.SortBy = "OrderTotal";
			Globals.EntityCoding(orderStatisticsQuery, true);
			DbQueryResult dbQueryResult = ShopStatisticHelper.Member_GetStatisticReport(orderStatisticsQuery);
